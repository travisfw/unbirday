...
import travisfw.unbirday.adapters.MissedCarouselAdapter
import travisfw.unbirday.databinding.BottomSheetQuickAppsBinding
                ...
                if (requireContext().checkSelfPermission(android.Manifest.permission.READ_CONTACTS) == android.content.pm.PackageManager.PERMISSION_GRANTED) {
                    Thread {
                        try {
                            ...
                            val contactId = travisfw.unbirday.persistence.ContactsRepository()
